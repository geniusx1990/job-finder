...
function Filters({ accessToken, keyword, onApply, onReset }: FiltersProps) {
  ...
  return (
    <Container className="filters_component" size="315px" style={{ marginBottom: '20px', border: 'solid 2px #EAEBED', borderRadius: '12px', padding: '20px', margin: '0', height: '360px', backgroundColor: '#FFFFFF' }}>
      ...
      <Select
        ...
        rightSection={<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M5 9L11.2191 14.3306C11.6684 14.7158 12.3316 14.7158 12.7809 14.3306L19 9" stroke="#ACADB9" strokeWidth="1.5" strokeLinecap="round" />
                      </svg>
        }
      />
